...
namespace AnimalExplorer.Factory{
    public class AnimalSettingsViewSelector : DefaultTypedFactoryComponentSelector
    {
        public AnimalSettingsViewSelector() : base(fallbackToResolveByTypeIfNameNotFound: true)
        {
